...
- **Cómo hablar con Cursor (ahorrar tokens):** mensajes cortos y concretos. Di la pantalla + el problema + el resultado esperado (ej. «Ajustes: falta Acerca de; idioma en Ajustes»). Evita pegar logs enormes o reenviar el historial. Una petición por mensaje cuando puedas. No hace falta pedirme «prueba el APK» ni «haz commit»: ya va en las reglas.
